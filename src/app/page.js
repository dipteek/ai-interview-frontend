...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Job Role Based Interview</title>
        <meta name="description" content="Prepare for your job interview" />
      </Head>
      ...
      <main className={styles.main}>
        ...
        {!selectedRole ? (
          ...
          <div className={styles.interviewSetup}>
            <h2>Setup Interview for {selectedRole.title}</h2>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.techStackContainer}>
                {availableTechStacks.map((tech) => (
                  <button
                    key={tech}
                    className={`${styles.techButton} ${techStack.includes(tech) ? styles.selected : ''}`}
